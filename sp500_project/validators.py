...
def check_generation_number(number):
...
def check_symbol_uniqueness(symbol, db_connector):
...
def check_symbol_existence(symbol, db_connector):
    file = db_connector.get_file_information()
